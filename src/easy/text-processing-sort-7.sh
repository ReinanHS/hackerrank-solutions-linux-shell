# Você recebe um arquivo de dados meteorológicos delimitados por tubos (TSV). Não há coluna de cabeçalho neste arquivo de dados. 
...
# Você precisa classificar este arquivo em ordem decrescente da segunda coluna (ou seja, a temperatura média mensal em janeiro).
